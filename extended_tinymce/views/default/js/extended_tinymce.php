...
elgg.extended_tinymce.init = function() {
    ...
    tinyMCE.init({
        ...
        plugins: "advlist autolink autosave charmap code colorpicker emoticons fullscreen hr image insertdatetime link lists paste preview print searchreplace table textcolor textpattern wordcount",
        menubar: false,
