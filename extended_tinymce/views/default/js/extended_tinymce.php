...
elgg.extended_tinymce.init = function() {
    ...
    tinyMCE.init({
        ...
        plugins: "advlist autolink autosave charmap code emoticons hr image insertdatetime link lists paste preview print searchreplace table textcolor wordcount",
        menubar: false,
